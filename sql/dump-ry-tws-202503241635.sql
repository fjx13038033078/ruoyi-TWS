...
--
-- Host: localhost    Database: ry-tws
-- ------------------------------------------------------
...
INSERT INTO `sys_dept` VALUES (100,0,'0','XXX医院',0,'韦小宝','15888888888','ry@qq.com','0','0','admin','2024-02-28 22:23:42','admin','2025-03-11 10:21:58'),(101,100,'0,100','深圳总公司',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(102,100,'0,100','长沙分公司',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(103,101,'0,100,101','研发部门',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(104,101,'0,100,101','市场部门',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(105,101,'0,100,101','测试部门',3,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(106,101,'0,100,101','财务部门',4,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(107,101,'0,100,101','运维部门',5,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(108,102,'0,100,102','市场部门',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(109,102,'0,100,102','财务部门',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(200,100,'0,100','AAA科室',1,NULL,NULL,NULL,'0','0','admin','2025-01-09 09:56:28','admin','2025-03-11 10:22:12'),(201,100,'0,100','BBB科室',2,NULL,NULL,NULL,'0','0','admin','2025-01-09 09:56:48','admin','2025-03-11 10:22:20');
...
) ENGINE=InnoDB AUTO_INCREMENT=332 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_notice` VALUES (1,'系统开放','2',_binary '<p>系统台开放，欢迎大家使用</p>','0','admin','2024-02-28 22:23:43','admin','2025-03-11 10:23:26','管理员'),(2,'系统维护公告','1',_binary '<p>大学生学籍管理管理系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2025-01-09 09:55:27','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=334 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'游客','tourist',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-04-18 15:06:26','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','2','admin','2024-02-28 22:41:32','admin','2024-03-09 18:14:20','普通用户'),(102,'老师','doctor',3,'1',0,1,'0','2','admin','2025-01-08 10:15:29','admin','2025-03-11 10:20:36',NULL),(103,'患者','patient',4,'1',0,1,'0','0','admin','2025-01-08 10:16:01','admin','2025-03-24 16:31:38',NULL);
...
INSERT INTO `sys_role_menu` VALUES (103,1035),(103,2056),(103,2057);
...
CREATE TABLE `sys_user` (
  ...
  `emergency_contact` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '紧急联系人',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-03-24 16:30:54','admin','2024-02-28 22:23:42','','2025-03-24 16:30:53','管理员',333.20,NULL,NULL,NULL,NULL),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL,NULL,NULL,NULL,NULL),(100,100,'zhangsan','张三','00','','13089876578','0','/profile/avatar/2024/03/25/屏幕截图 2024-03-07 113152_20240325091732A004.png','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','2','127.0.0.1','2024-03-25 09:17:20','admin','2024-03-04 18:58:34','admin','2024-03-26 09:45:29',NULL,10.00,NULL,NULL,NULL,NULL),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','2','',NULL,'admin','2024-03-04 18:58:57','admin','2024-03-26 09:45:34',NULL,10.00,NULL,NULL,NULL,NULL),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','2','127.0.0.1','2024-03-10 11:35:34','admin','2024-03-04 18:59:22','admin','2024-03-10 11:35:33',NULL,9666.80,NULL,NULL,NULL,NULL),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','2','127.0.0.1','2024-03-06 15:38:23','admin','2024-03-04 18:59:55','admin','2024-03-08 10:19:42',NULL,10000.00,NULL,NULL,NULL,NULL),(104,100,'zhangsan','张三','00','56789765@qq.com','13036856974','0','','$2a$10$lfE/uN5HDx82NTuxXVbIauSOI26DwLQBPwMrO7zujNfAvlBA64SWS','0','0','127.0.0.1','2025-03-24 16:31:55','admin','2024-03-26 09:47:17','admin','2025-03-24 16:33:15',NULL,NULL,'111111111',78,'北京市东城区甜水井胡同109','13098987896'),(105,NULL,'李四','lisi','00','','13065984573','1','','$2a$10$6U179rVh0VoPz/huXWmuH.ImRLh8mTdsx8GuXGngTXWzjyy6CyKKe','0','2','',NULL,'admin','2024-03-26 14:29:20','',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(106,200,'lisi','李四','00','','13035682654','1','','$2a$10$G65ARoR9tEkC6KLTXlgf.ONcE/3BDCeqJGB9ueMefUxveOfalFK..','0','0','127.0.0.1','2025-03-19 14:45:05','admin','2024-03-26 14:29:47','admin','2025-03-19 14:45:05',NULL,NULL,NULL,NULL,NULL,NULL),(107,NULL,'fjx','fjx','00','','','0','','$2a$10$TEfqxhFzOzlpnkHbUuKEvuB7rSYu8XY9onRI2oiLGV6s9DCVPvgoG','0','2','127.0.0.1','2024-04-11 15:04:53','','2024-04-11 15:04:30','','2024-04-11 15:04:52',NULL,NULL,NULL,NULL,NULL,NULL),(108,100,'wangwu','王五','00','','','0','','$2a$10$4pMcTMLiMgi9UyG4iyRUSO9.PuTIwNvxdL766.YfzT15ooQRg5ssW','0','0','127.0.0.1','2025-03-19 09:28:09','admin','2025-01-09 15:57:49','admin','2025-03-19 09:28:09',NULL,NULL,NULL,NULL,NULL,NULL),(109,201,'zhaoliu','赵六','00','','15167890987','0','','$2a$10$tkgRvDuSiBi0IHtGxxuTfeXdSPspj/dYOpoXv4q4P6PnZNU0wXHgO','0','0','127.0.0.1','2025-01-15 10:35:12','admin','2025-01-09 15:58:30','','2025-01-15 10:35:11',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `sys_user_role` VALUES (1,1),(104,103),(106,103),(108,103),(109,103);
/*!40000 ALTER TABLE `sys_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tws_organ`
--

DROP TABLE IF EXISTS `tws_organ`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tws_organ` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '供体ID，主键',
  `organ_type` tinyint NOT NULL COMMENT '器官类型，如肝、肾、心脏等',
  `blood_type` tinyint NOT NULL,
  `donor_name` varchar(100) DEFAULT NULL COMMENT '供体姓名（可匿名）',
  `availability_status` tinyint NOT NULL COMMENT '器官状态(''可用'', ''已分配'', ''不可用'')',
  `create_time` datetime NOT NULL COMMENT '录入时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='器官供体表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tws_organ`
--

LOCK TABLES `tws_organ` WRITE;
/*!40000 ALTER TABLE `tws_organ` DISABLE KEYS */;
/*!40000 ALTER TABLE `tws_organ` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tws_patient`
--

DROP TABLE IF EXISTS `tws_patient`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tws_patient` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '登记ID，主键',
  `user_id` bigint DEFAULT NULL COMMENT '患者ID，外键关联用户表',
  `organ_needed` tinyint NOT NULL COMMENT '所需器官（0: 肝, 1: 肾）',
  `blood_type` tinyint NOT NULL COMMENT '血型（0: A, 1: B, 2: AB, 3: O）',
  `emergency_status` tinyint NOT NULL COMMENT '病情是否紧急（0-否，1-是）',
  `status` tinyint NOT NULL COMMENT '状态（0: 审核中, 1: 等待移植, 2: 准备移植, 3: 完成移植, 4: 已放弃）',
  `hla_typing` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'HLA配型信息',
  `hbv_infected` tinyint NOT NULL COMMENT '是否感染乙肝病毒（0: 否, 1: 是）',
  `hcv_infected` tinyint NOT NULL COMMENT '是否感染丙肝病毒（0: 否, 1: 是）',
  `hiv_infected` tinyint NOT NULL COMMENT '是否感染艾滋病病毒（0: 否, 1: 是）',
  `medical_status` tinyint NOT NULL COMMENT '医疗状态（0: 在重症监护室, 1: 住院, 2: 不在重症监护室, 3: 未住院）',
  `self_assessment` tinyint NOT NULL COMMENT '自评状态（0: 病情稳定, 1: 病情反复, 2: 情况危殆）',
  `medical_condition` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '病情描述',
  `create_time` datetime NOT NULL COMMENT '登记时间',
  `is_on_dialysis` tinyint DEFAULT NULL COMMENT '是否正在透析（0: 否, 1: 是，仅适用于肾移植）',
  `dialysis_type` tinyint DEFAULT NULL COMMENT '透析类型（0: 血液透析, 1: 腹膜透析，仅适用于肾移植）',
  `first_dialysis_date` date DEFAULT NULL COMMENT '初次透析时间，仅适用于肾移植',
  `dialysis_frequency` varchar(50) DEFAULT NULL COMMENT '透析频率（如每周3次，仅适用于肾移植）',
  `file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '附件',
  `creatinine` decimal(6,2) DEFAULT NULL COMMENT '肌酐，单位 umol/L',
  `alt` decimal(6,2) DEFAULT NULL COMMENT '谷丙转氨酶（ALT），单位 U/L',
  `ast` decimal(6,2) DEFAULT NULL COMMENT '谷草转氨酶（AST），单位 U/L',
  `leukemia` tinyint DEFAULT NULL COMMENT '是否患有白血病（0: 否, 1: 是）',
  `fracture_last_year` tinyint DEFAULT NULL COMMENT '过去一年内是否曾骨折（0: 否, 1: 是）',
  `avascular_necrosis` tinyint DEFAULT NULL COMMENT '是否患有血管性骨坏死（0: 否, 1: 是）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='患者登记表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tws_patient`
--

LOCK TABLES `tws_patient` WRITE;
/*!40000 ALTER TABLE `tws_patient` DISABLE KEYS */;
INSERT INTO `tws_patient` VALUES (1,109,0,1,1,4,'',0,0,0,0,0,'疾病','2025-03-11 15:49:36',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,106,1,0,0,1,'配型',0,0,0,0,0,'病情描述','2025-03-11 16:38:16',1,0,'2025-03-09','每周4次','',2.00,2.00,2.00,0,0,0),(9,108,1,0,0,1,'配型',0,0,0,0,0,'病情描述','2025-03-24 16:26:58',1,NULL,'2008-12-01','每周4次',NULL,2.00,2.00,2.00,0,0,0),(10,104,0,1,1,4,NULL,0,0,0,0,0,'疾病','2025-03-24 16:26:58',0,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `tws_patient` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ry-tws'
--
...
-- Dump completed on 2025-03-24 16:35:26
