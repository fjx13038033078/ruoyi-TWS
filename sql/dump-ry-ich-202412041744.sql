...
CREATE TABLE `sms_course` (
  ...
  `course_credits` int NOT NULL COMMENT '课程学分',
  `course_hours` int NOT NULL COMMENT '课程学时',
  `instructor_name` varchar(100) NOT NULL COMMENT '授课教师姓名',
...
CREATE TABLE `sms_grade` (
  ...
  `grade` decimal(5,1) NOT NULL COMMENT '成绩，支持百分制（0-100）',
...
) ENGINE=InnoDB AUTO_INCREMENT=226 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'游客','tourist',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-04-18 15:06:26','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','2','admin','2024-02-28 22:41:32','admin','2024-03-09 18:14:20','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (2,107),(2,1035),(2,1036),(2,1037),(2,1038),(2,2001),(2,2002),(2,2003),(2,2005),(2,2006),(2,2013),(2,2019),(2,2020),(2,2021),(2,2031),(2,2032),(2,2033),(2,2034),(2,2036),(2,2040),(2,2041),(2,2044);
...
-- Dump completed on 2024-12-04 17:44:53
