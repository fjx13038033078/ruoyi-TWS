...
) ENGINE=InnoDB AUTO_INCREMENT=262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'游客','tourist',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-04-18 15:06:26','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','2','admin','2024-02-28 22:41:32','admin','2024-03-09 18:14:20','普通用户'),(102,'老师','doctor',3,'1',0,1,'0','0','admin','2025-01-08 10:15:29','admin','2025-03-11 10:20:36',NULL),(103,'学生','patient',4,'1',0,1,'0','0','admin','2025-01-08 10:16:01','admin','2025-03-11 10:20:45',NULL);
...
CREATE TABLE `tws_patient` (
  ...
  `organ_needed` tinyint NOT NULL COMMENT '所需移植的器官，如肝、肾、心脏等',
  `blood_type` tinyint NOT NULL COMMENT '血型，如A、B、AB、O',
  `medical_condition` varchar(100) DEFAULT NULL COMMENT '病情描述',
  `emergency_status` tinyint NOT NULL COMMENT '病情是否紧急（0-否，1-是）',
  `status` tinyint NOT NULL COMMENT '当前状态(''审核中'', ''等待移植'', ''准备移植'', ''完成移植'', ''已放弃'')',
  `create_time` datetime NOT NULL COMMENT '登记时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='患者登记表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tws_patient` VALUES (1,109,0,1,'疾病',0,0,'2025-03-11 15:49:36'),(2,106,1,0,'病情描述',0,1,'2025-03-11 16:38:16');
...
-- Dump completed on 2025-03-11 16:44:57
