...
INSERT INTO `sms_course` VALUES (1,'数据结构',6,16,104,'春季','请求'),(2,'高等数学（下）',6,30,104,'春季','高等数学'),(3,'计算机网络',4,16,108,'春季','计算机网络'),(4,'计算机组成原理',4,20,108,'春季','计算机组成原理');
...
INSERT INTO `sms_grade` VALUES (1,106,2,80,'基金来了'),(2,109,1,55,''),(3,109,3,59,'下学期补考'),(4,106,4,88,''),(5,106,3,88,''),(6,109,2,90,'');
...
) ENGINE=InnoDB AUTO_INCREMENT=248 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-10 11:44:04
